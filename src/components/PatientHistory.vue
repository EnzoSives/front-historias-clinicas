            ...
            <div class="col-12 col-md">
              <q-card flat bordered>
                <q-card-section>
                  ...
                  <div class="q-mt-sm text-caption">{{ patient.medicacionHabitual || "No toma medicamentos actualmente."
                  }}</div>
                </q-card-section>
              </q-card>
            </div>
          ...
          <q-expansion-item expand-separator icon="list" label="Revisión Detallada por Sistemas"
            ...
            <q-card>
              <q-card-section>
                ...
                <p><strong>Sistema Musculoesquelético:</strong> {{ patient.examenFisicoSistemaMusculoEsqueletico }}</p>
